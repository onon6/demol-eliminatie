...
import com.dpeeters.molelim.io.GeelimineerdenReader;
import com.dpeeters.molelim.media.ImageModel;
import com.dpeeters.molelim.media.MusicPlayer;
...
public class ResultDelegator {
    ...
    public void enterPressed(String candidateName) {
        if (isShowingResult) {
            ...
            musicPlayer.stopEliminatedMusic();
            return;
        }
